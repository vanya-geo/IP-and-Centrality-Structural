...
def solver(W_init,params,L,alp,gam,chi_mat,tau_mat,tau_L,solve_eq):
    ...
    for cc in range(1,C+1):
        ...
        #exports 
        exports_intermeds=np.sum(R_mat[foreign_sectors,(cc-1)*J:cc*J])    
        exports_cons=np.sum((Y_c[countries_except_cc]+Pi_c[countries_except_cc])@s_h_mat[np.ix_(countries_except_cc, domestic_sectors)])
